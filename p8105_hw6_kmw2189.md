...
<img src="p8105_hw6_kmw2189_files/figure-gfm/unnamed-chunk-2-2.png" width="90%" />

Both the distribution of the r squared values and the log of Beta 0 x
Beta 1 appear to be normal. A linear regressionwould be appropriate to
use with the data.
...
The 95% confidence interval for r squared is 0.89 to 0.93 and the 95%
confidence interval for log(β<sup>0∗β</sup>1) is 1.96 to 2.06
