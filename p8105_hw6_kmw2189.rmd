...
**Conclusion**
My initially predicted model using gestational age, maternal BMI, and income as an SES measure did not perform nearly as well as I anticipated! Model 3, or the "fully loaded" model containing head cinrumference, birth length and sex interactions perfomred the best. If I were to revise my original model I would definitely include birth length. 
